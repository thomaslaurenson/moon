...
Pin runners; never use `-latest`, and never a Preview image. Generally available at the time of writing: `ubuntu-24.04`, `ubuntu-24.04-arm`, `ubuntu-22.04`, `macos-26`, `macos-26-intel`, `macos-15`, `macos-15-intel`, `windows-2025`, `windows-2022`, `windows-11-arm`. Linux jobs default to `ubuntu-24.04`.
