...
- For C++ the ecosystem is `gitsubmodule`, because every dependency is a pinned git submodule under `extern/` and there is no package manager to ask; see cpp/cmake. Dependabot then proposes a bump to the commit each submodule points at.
