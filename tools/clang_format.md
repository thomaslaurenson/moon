...
`clang-format-18` must be installed. The `make install_clang_tools` target handles this. Always use the pinned version — different versions can produce different formatting output.
